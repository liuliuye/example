...
LCD_OP_SECTION lcddev_t ili9341 = 
{
    .name = "ili9341",
    ...
    .te_mode = 1,//0xff,//0xff,//te mode, 0xff:disable
    //f(wr) = source_clk/div/2
    //f(wr) >= screen_w * screen_h * clk_per_pixel * 60
    .pclk_div = PLL_CLK/(240*320*2*110)/2,
    .even_order = 0,
    .odd_order = 0,
