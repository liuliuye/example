...
BEGIN_INIT_TAB
	...
	//CMD(0x00),CMD(0x03),DAT(0x10),DAT(0x20), // set GRAM write direction and BGR=1.
	CMD(0x00),CMD(0x03),DAT(0x10),DAT(0x30), // set GRAM write direction and BGR=1.
	//CMD(0x00),CMD(0x03),DAT(0x10),DAT(0x1B), // set GRAM write direction and BGR=1.
	...
	CMD(0x00),CMD(0x33),DAT(0x00),DAT(0x00),
...
LCD_OP_SECTION lcddev_t ili9225g = 
{
	...
	.bus_cmd = 0,	// 0 : 8bit , 1 16 bit 
	.scan_mode = LCD_ROTATE_90,
    .te_mode =  1,//1,//te mode, 0xff:disable
