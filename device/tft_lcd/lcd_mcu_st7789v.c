...
#if defined(USB_LCD_ST7789P3BOE2_0IPS)
BEGIN_INIT_TAB
DLAY(120),                
...
LCD_OP_SECTION lcddev_t st7789v = 
{
    ...
    #elif defined(USE_BOARD_DY06)||defined(USE_BOARD_DY45)||defined(USE_BOARD_DY79)||defined(USE_BOARD_DY116)||defined(USE_BOARD_DY152)
