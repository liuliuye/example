...
*/
    ...
    lcd_spi_write_command(0x000f),
    //lcd_spi_write_command(0x504a),	//vcom 0x504a
    lcd_spi_write_command(0x506D),			//vcom
    lcd_delay_ms(50),

    lcd_spi_write_command(0x3008),
    lcd_spi_write_command(0x4000),	// mirr&flip  0x4003
    
    lcd_spi_write_command(0x7040),		//default 0x7040
    lcd_spi_write_command(0xC005),
    lcd_spi_write_command(0xE013),
    lcd_spi_write_command(0x6001),		// NTSC
    lcd_delay_ms(150),
